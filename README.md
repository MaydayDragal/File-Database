...
- **Select many at once** — checkboxes, Shift+click ranges, or Ctrl+A, then set the collection, tags or VIN for the whole batch, star or delete them, or send them together to LI Documents / a Toolbox tool (PDF merge receives them all at once).
