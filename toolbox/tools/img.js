...
(function () {
  ...
  // AVIF encode support
  (function () { var c = document.createElement("canvas"); c.width = c.height = 2; c.toBlob(function (b) { if (!b || b.type !== "image/avif") { var btn = document.querySelector('#g-cv-fmt button[data-v="image/avif"]'); if (btn) { btn.disabled = true; btn.style.opacity = ".4"; btn.title = "Your browser can't encode AVIF"; } } }, "image/avif"); })();
