...
export function init(root) {
  ...
  var els = {
    drop: root.getElementById("z-drop"),
    fileInput: root.getElementById("z-fileInput"),
    filemeta: root.getElementById("z-filemeta"),
    fileName: root.getElementById("z-fileName"),
    fileStats: root.getElementById("z-fileStats"),
    clearFile: root.getElementById("z-clearFile"),
    countRow: root.getElementById("z-countRow"),
    sizeRow: root.getElementById("z-sizeRow"),
    countVal: root.getElementById("z-countVal"),
    sizeVal: root.getElementById("z-sizeVal"),
    sizeUnit: root.getElementById("z-sizeUnit"),
    runBtn: root.getElementById("z-runBtn"),
    progWrap: root.getElementById("z-progWrap"),
    progBar: root.getElementById("z-progBar"),
    progLabel: root.getElementById("z-progLabel"),
    err: root.getElementById("z-err"),
    results: root.getElementById("z-results"),
    resultsTitle: root.getElementById("z-resultsTitle"),
    partsList: root.getElementById("z-partsList"),
    downloadAll: root.getElementById("z-downloadAll"),
    fmtToggle: root.getElementById("z-fmtToggle"),
    fmtHint: root.getElementById("z-fmtHint")
  };
  ...
  // ---------- mode selection ----------
  root.querySelectorAll(".mode").forEach(function (m) {
    m.addEventListener("click", function () {
      var mode = m.getAttribute("data-mode");
      selectMode(mode);
    });
  });
  root.querySelectorAll('input[name=mode]').forEach(function (r) {
  ...
  function selectMode(mode) {
    ...
    var radio = root.querySelector('input[name=mode][value="' + mode + '"]');
