...
// add, a search keystroke, a sync import all do this in real use. The
// preview's blob URL must survive them (it lives on previewUrls, not the
// per-render objectUrls set).
